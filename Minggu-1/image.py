...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.photo.setGeometry(QtCore.QRect(100, 40, 371, 211))
        self.photo.setText("")
        self.photo.setPixmap(QtGui.QPixmap("cat.jpeg"))
        self.photo.setScaledContents(True)
        self.photo.setObjectName("photo")
        self.cat = QtWidgets.QPushButton(self.centralwidget)
        self.cat.setGeometry(QtCore.QRect(30, 270, 241, 51))
        self.cat.setObjectName("cat")
        self.dog = QtWidgets.QPushButton(self.centralwidget)
        self.dog.setGeometry(QtCore.QRect(270, 270, 241, 51))
    ...
    def show_dog(self):
        self.photo.setPixmap(QtGui.QPixmap("dog.jpeg"))
